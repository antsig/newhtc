...
@section('left-sidebar')
    @include('layouts.partials.left_sidebar_placeholder')
@endsection
...
<div class="bg-white border p-4 mb-4">
    <h1 class="fw-bold mb-4" style="color:#074174; border-bottom:2px solid #eee; padding-bottom:10px;">Berita Kategori: {{ $kategori->nama_kategori }}</h1>
