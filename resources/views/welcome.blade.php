...
@section('left-sidebar')
    ...
    <div class="mb-3 bg-white" style="border: 4px solid #fcf2e3; padding:2px;">
        <img src="{{ asset('images/no-image.png') }}" class="img-fluid w-100 object-fit-cover" alt="Sertifikat Akreditasi" style="height:250px;" loading="lazy">
    </div>
    ...
    <div class="bg-white border p-0 mb-4 position-relative">
        @if($albumTerbaru)
            <img src="{{ $albumTerbaru->gbr_album ? Storage::url($albumTerbaru->gbr_album) : asset('images/no-image.png') }}" class="img-fluid w-100 object-fit-cover" style="height:200px;" alt="{{ $albumTerbaru->jdl_album }}" loading="lazy">
    ...
    <div class="bg-white border p-0 mb-4 text-center">
        @if(isset($videoTerbaru) && $videoTerbaru)
            <div class="ratio ratio-16x9">
                <iframe src="{{ str_replace('watch?v=', 'embed/', $videoTerbaru->youtube_url) }}" allowfullscreen loading="lazy"></iframe>
            </div>
            ...
            <div class="carousel-inner position-relative">
                ...
                <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                    <a href="{{ url('berita/'.$news->judul_seo) }}" class="text-decoration-none">
                        <img src="{{ $news->gambar ? Storage::url($news->gambar) : asset('images/no-image.png') }}" class="d-block w-100 object-fit-cover" alt="{{ $news->judul }}" style="height:350px;" loading="eager">
    ...
    <div class="bg-white border p-3 pt-0 mb-4">
        ...
        <div class="row align-items-start py-3 border-bottom">
            <div class="col-4 pe-0">
                <img src="{{ $news->gambar ? asset('storage/'.$news->gambar) : asset('images/no-image.png') }}" class="img-fluid w-100 object-fit-cover" alt="News Image" style="height:100px;" loading="lazy">
            </div>
            <div class="col-8">
...
@section('right-sidebar')
    ...
    <div class="bg-white border p-3">
        ...
        <div class="d-flex mb-3 align-items-start {{ !$loop->last ? 'border-bottom pb-2' : '' }}">
            <img src="{{ $news->gambar ? Storage::url($news->gambar) : asset('images/no-image.png') }}" class="me-2 flex-shrink-0" style="width:60px; height:60px; object-fit:cover;" alt="Berita Utama" loading="lazy">
            <div>
    ...
    <div class="bg-white border p-3">
        ...
        <div class="d-flex mb-3 align-items-start border-bottom pb-2">
            <img src="{{ $news->gambar ? Storage::url($news->gambar) : asset('images/no-image.png') }}" class="me-2 flex-shrink-0" style="width:60px; height:40px; object-fit:cover;" alt="Berita Populer" loading="lazy">
            <div>
